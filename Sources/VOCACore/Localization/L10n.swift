...
public enum L10n: String, CaseIterable, Sendable {
    ...
    private static let en: [L10n: String] = [
        ...
        .memoryLearnedSection: "Frequently used phrases",
        .memoryLearnedHint: "Phrases you've said two or more times. Used as STT hints to bias the transcription model. Different from auto-learned dictionary entries — those come from edits you make after a paste.",
        .memoryLearnedEmpty: "Nothing tracked yet — say the same proper noun a couple of times and it shows up here.",
    ...
    private static let zhHant: [L10n: String] = [
        ...
        .memoryLearnedSection: "常用詞彙",
        .memoryLearnedHint: "你說過兩次以上的詞，VOCA 會在轉錄時拿來提示語音辨識模型。跟字典裡的「自動學到」不一樣——那邊來自你貼上後的修改。",
        .memoryLearnedEmpty: "目前還沒追蹤到——同一個專有名詞講個兩次以上就會出現在這裡。",
