...
public final class TextInjector {
    ...
    private func paste(_ text: String) async throws {
        ...
        // Honour the de-facto nspasteboard.org "concealed" convention.
        // Clipboard managers (Paste, Maccy, Alfred, etc.) skip recording
        // pasteboard items that carry these UTIs. The actual transcript
        // is still readable for ⌘V to consume, but it won't be archived
        // into a clipboard history.
