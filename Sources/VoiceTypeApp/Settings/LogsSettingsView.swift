...
struct LogsSettingsView: View {
    ...
    var body: some View {
        SettingsPage(
            title: "Logs",
            subtitle: "Every step the engine takes, persisted to ~/Library/Application Support/VoiceType/log.jsonl. Use this to see why a take dropped or which provider failed."
        ) {
            filtersCard
            entriesCard
            footerCard
